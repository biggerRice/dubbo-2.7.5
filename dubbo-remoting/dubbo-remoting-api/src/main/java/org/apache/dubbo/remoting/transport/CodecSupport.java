...
//            logger.info("初始化序列化方式数据 ID_SERIALIZATION_MAP:"+JSON.toJSONString(ID_SERIALIZATION_MAP));
//            logger.info("初始化序列化方式数据 ID_SERIALIZATIONNAME_MAP:"+JSON.toJSONString(ID_SERIALIZATIONNAME_MAP));
        }
    }
