...
public class ChannelHandlers {
    ...
    protected ChannelHandler wrapInternal(ChannelHandler handler, URL url) {
        ...
        Dispatcher dispatcher = ExtensionLoader.getExtensionLoader(Dispatcher.class)
                .getAdaptiveExtension();
        return new MultiMessageHandler(new HeartbeatHandler(dispatcher.dispatch(handler, url)));
    }
}
