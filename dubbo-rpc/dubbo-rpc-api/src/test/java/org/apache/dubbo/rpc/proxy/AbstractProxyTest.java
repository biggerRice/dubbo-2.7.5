...
public abstract class AbstractProxyTest {
    ...
    @Test
    public void testProxyFactory$Adaptive() throws Exception {
        URL url = URL.valueOf("test://test:11/test?group=dubbo&version=1.1");

        Invoker<DemoService> invoker = new MyInvoker<>(url);

        Invoker proxy = PROXY_FACTORY.getInvoker(new org.apache.dubbo.rpc.proxy.DemoServiceImpl(), org.apache.dubbo.rpc.proxy.DemoService.class,url);
