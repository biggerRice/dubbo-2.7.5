...
final class ReferenceCountExchangeClient implements ExchangeClient {
    ...
    private static Logger logger = LoggerFactory.getLogger(ReferenceCountExchangeClient.class);
...
//        logger.info("ReferenceCountExchangeClient 类 ExchangeClient client="+ JSON.toJSONString(client, SerializerFeature.IgnoreNonFieldGetter) );
    }
